...
export function setAnalysisConfig(before_after,before_after_diff,group_before,group_after,user, beforeStart=new Date(), beforeEnd, afterStart, afterEnd, update, type) {
  ...
  return new Promise((resolve, reject) => {
    ...
    Promise.all(proc).then(() => {
      ...
      console.error(all,datas.before,datas.after)
      resolve({
        xAxis: {
          type: 'category',
          boundaryGap: false,
